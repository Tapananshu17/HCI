...
const processingSteps = {
  ...
  gu: [
    { id: 1, text: 'તમારા પ્રતિસાદોનું વિશ્લેષણ કરી રહ્યા છીએ...', duration: 2000 },
    { id: 2, text: 'તમારી શક્તિઓની ઓળખ કરી રહ્યા છીએ...', duration: 2500 },
    { id: 3, text: 'કારકિર્દી માર્ગો સાથે મેચિંગ કરી રહ્યા છીએ...', duration: 3000 },
...
const translations = {
  en: {
    ...
    successDesc: 'We\'ve analyzed your responses and prepared personalized career recommendations based on your aptitudes, values, and interests.',
    viewResults: 'View Results',
    progress: 'Progress',
    didKnow: 'Did you know?',
    funFact: 'There are over 12,000 different career options available in India! We\'re helping you find the ones that match your unique profile.',
    thankYou: 'Thank you for completing the assessment'
  },
  hi: {
    processing: 'आपके मूल्यांकन का विश्लेषण',
    complete: 'विश्लेषण पूर्ण!',
    pleaseWait: 'कृपया प्रतीक्षा करें जब तक हम आपकी प्रतिक्रियाओं का विश्लेषण करते हैं',
    success: 'आपकी व्यक्तिगत करियर सिफारिशें तैयार हैं',
    successDesc: 'हमने आपकी प्रतिक्रियाओं का विश्लेषण किया है और आपकी योग्यताओं, मूल्यों और रुचियों के आधार पर व्यक्तिगत करियर सिफारिशें तैयार की हैं।',
    viewResults: 'परिणाम देखें',
    progress: 'प्रगति',
    didKnow: 'क्या आप जानते हैं?',
    funFact: 'भारत में 12,000 से अधिक विभिन्न करियर विकल्प उपलब्ध हैं! हम आपको वे खोजने में मदद कर रहे हैं जो आपकी अनूठी प्रोफ़ाइल से मेल खाते हैं।',
    thankYou: 'मूल्यांकन पूरा करने के लिए धन्यवाद'
  },
  te: {
    processing: 'మీ అసెస్‌మెంట్‌ను ప్రాసెస్ చేస్తోంది',
    complete: 'విశ్లేషణ పూర్తయింది!',
    pleaseWait: 'మేము మీ ప్రతిస్పందనలను విశ్లేషిస్తున్నప్పుడు దయచేసి వేచి ఉండండి',
    success: 'మీ వ్యక్తిగత కెరీర్ సిఫార్సులు సిద్ధంగా ఉన్నాయి',
    successDesc: 'మేము మీ ప్రతిస్పందనలను విశ్లేషించాము మరియు మీ సామర్థ్యాలు, విలువలు మరియు ఆసక్తుల ఆధారంగా వ్యక్తిగత కెరీర్ సిఫార్సులను సిద్ధం చేసాము।',
    viewResults: 'ఫలితాలు చూడండి',
    progress: 'పురోగతి',
    didKnow: 'మీకు తెలుసా?',
    funFact: 'భారతదేశంలో 12,000 కంటే ఎక్కువ వివిధ కెరీర్ ఎంపికలు అందుబాటులో ఉన్నాయి! మీ ప్రత్యేక ప్రొఫైల్‌కు సరిపోయేవాటిని కనుగొనడంలో మేము మీకు సహాయం చేస్తున్నాము।',
  ...
  ta: {
    ...
    pleaseWait: 'நாங்கள் உங்கள் பதில்களை பகுப்பாய்வு செய்யும் வரை காத்திருக்கவும்',
    success: 'உங்கள் தனிப்பயன் தொழில் பரிந்துரைகள் தயார்',
    successDesc: 'நாங்கள் உங்கள் பதில்களை பகுப்பாய்வு செய்து, உங்கள் திறன்கள், மதிப்புகள் மற்றும் ஆர்வங்களின் அடிப்படையில் தனிப்பயன் தொழில் பரிந்துரைகளை தயாரித்துள்ளோம்.',
    viewResults: 'முடிவுகளைப் பார்க்கவும்',
    progress: 'முன்னேற்றம்',
    didKnow: 'உங்களுக்குத் தெரியுமா?',
    funFact: 'இந்தியாவில் 12,000க்கும் மேற்பட்ட வெவ்வேறு தொழில் விருப்பங்கள் உள்ளன! உங்கள் தனித்துவமான சுயவிவரத்துடன் பொருந்தும் விருப்பங்களைக் கண்டறிய நாங்கள் உதவுகிறோம்.',
  ...
  bn: {
    ...
    successDesc: 'আমরা আপনার উত্তর বিশ্লেষণ করেছি এবং আপনার যোগ্যতা, মূল্যবোধ এবং আগ্রহের ভিত্তিতে ব্যক্তিগত ক্যারিয়ার সুপারিশ প্রস্তুত করেছি।',
    viewResults: 'ফলাফল দেখুন',
    progress: 'অগ্রগতি',
    didKnow: 'আপনি কি জানেন?',
    funFact: 'ভারতে 12,000 এরও বেশি বিভিন্ন ক্যারিয়ার বিকল্প উপলব্ধ! আমরা আপনাকে এমনগুলি খুঁজে পেতে সাহায্য করছি যা আপনার অনন্য প্রোফাইলের সাথে মেলে।',
    thankYou: 'মূল্যায়ন সম্পূর্ণ করার জন্য ধন্যবাদ'
  },
  gu: {
    processing: 'તમારું મૂલ્યાંકન પ્રોસેસ કરી રહ્યા છીએ',
    complete: 'વિશ્લેષણ પૂર્ણ!',
    pleaseWait: 'કૃપા કરી રાહ જુઓ જ્યારે અમે તમારા પ્રતિસાદોનું વિશ્લેષણ કરીએ છીએ',
    success: 'તમારી વ્યક્તિગત કારકિર્દી ભલામણો તૈયાર છે',
    successDesc: 'અમે તમારા પ્રતિસાદોનું વિશ્લેષણ કર્યું છે અને તમારી યોગ્યતાઓ, મૂલ્યો અને રુચિઓના આધારે વ્યક્તિગત કારકિર્દી ભલામણો તૈયાર કરી છે.',
    viewResults: 'પરિણામો જુઓ',
    progress: 'પ્રગતિ',
    didKnow: 'શું તમે જાણો છો?',
    funFact: 'ભારતમાં 12,000 થી વધુ વિવિધ કારકિર્દી વિકલ્પો ઉપલબ્ધ છે! અમે તમને તે વિકલ્પો શોધવામાં મદદ કરી રહ્યા છીએ જે તમારી અનન્ય પ્રોફાઇલ સાથે મેળ ખાય છે.',
    thankYou: 'મૂલ્યાંકન પૂર્ણ કરવા બદલ આભાર'
  }
};

export function ProcessingPage({ userProfile, setUserProfile, navigateTo, selectedTest }: ProcessingPageProps) {
              ...
              <div className="mt-8 p-6 bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg border-2 border-green-200">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <Button 
                      onClick={() => navigateTo('chatbot', true)}
