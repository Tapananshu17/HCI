...
export function HomePage({ userProfile, setUserProfile, navigateTo, savedAssessment, completedAssessments, startAssessmentFlow, onLogout }: HomePageProps) {
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Welcome Section */}
        <div className="mb-8">
          <h2 className="text-gray-900 mb-2">{t.welcome}, {userProfile.name}! 👋</h2>
        </div>
